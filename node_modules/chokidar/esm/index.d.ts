...
export declare class FSWatcher extends EventEmitter {
     ...
     */
    _throttle(actionType: ThrottleType, path: Path, timeout: number): false | {
        timeoutObject: any;
        clear: () => any;
        count: number;
    };
     ...
     */
    _awaitWriteFinish(path: Path, threshold: number, event: EventName, awfEmit: any): void;
    /**
 ...
 */
export declare const watch: (paths: string | string[], options: ChokidarOptions) => FSWatcher;
