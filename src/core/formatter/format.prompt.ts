...
class FormatPrompt {
     ...
     */
    async getOpenAiPrompt(contextArray: string[], prompt: string, completionType: string): Promise<string> {
        try {
     ...
     */
    async getDeepSeekPrompt(contextArray: string[], prompt: string, completionType: string): Promise<string> {
        try {
     ...
     */
    async getGroqPrompt(contextArray: string[], prompt: string, completionType: string): Promise<string> {
        try {
            const platform = 'groq';
