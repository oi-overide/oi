...
class Network {
   ...
   */
  async doRequest(requestData: any) {
   ...
   */
  async handleOpenAIRequest(activeServiceDetails:ActivePlatformDetails, metadata: any) {
   ...
   */
  async handleDeepSeekRequest(activeServiceDetails:ActivePlatformDetails, metadata: any) {
   ...
   */
  async handleGroqRequest(activeServiceDetails:ActivePlatformDetails, metadata: any) {
